...
{
    internal class RepositoryCache<T, TKey, TState> : IRepositoryFacade<T, TKey, TState>, IRepositoryPattern<T, TKey, TState>, ICommandPattern<T, TKey, TState>, IQueryPattern<T, TKey, TState>, IRepositoryPattern, ICommandPattern, IQueryPattern
         where TKey : notnull
    {
        private readonly IRepositoryPattern<T, TKey, TState> _repository;

        public RepositoryCache(IRepositoryPattern<T, TKey, TState> repository)
        {
