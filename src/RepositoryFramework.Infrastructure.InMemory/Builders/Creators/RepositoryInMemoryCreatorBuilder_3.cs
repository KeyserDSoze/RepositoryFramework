...
{
    internal class RepositoryInMemoryCreatorBuilder<T, TKey, TState> : IRepositoryInMemoryCreatorBuilder<T, TKey, TState>
        where TKey : notnull
        where TState : class, IState<T>, new()
    {
        ...
        public IRepositoryInMemoryCreatorBuilder<T, TKey, TState> WithPattern<TProperty>(Expression<Func<T, TProperty>> navigationPropertyPath, params string[] regex)
        {
        ...
        public IRepositoryInMemoryCreatorBuilder<T, TKey, TState> WithSpecificNumberOfElements<TProperty>(Expression<Func<T, TProperty>> navigationPropertyPath, int numberOfElements)
        {
            string nameOfProperty = GetNameOfProperty(navigationPropertyPath);
        ...
        public IRepositoryInMemoryCreatorBuilder<T, TKey, TState> WithValue<TProperty>(Expression<Func<T, TProperty>> navigationPropertyPath, Func<TProperty> creator)
        {
            string nameOfProperty = GetNameOfProperty(navigationPropertyPath);
        ...
        public IRepositoryInMemoryCreatorBuilder<T, TKey, TState> WithAutoIncrement<TProperty>(Expression<Func<T, TProperty>> navigationPropertyPath, TProperty start)
        {
            string nameOfProperty = GetNameOfProperty(navigationPropertyPath);
        ...
        public IRepositoryInMemoryCreatorBuilder<T, TKey, TState> WithImplementation<TProperty>(Expression<Func<T, TProperty>> navigationPropertyPath, Type implementationType)
        {
            string nameOfProperty = GetNameOfProperty(navigationPropertyPath);
        ...
        public IRepositoryInMemoryCreatorBuilder<T, TKey, TState> WithImplementation<TProperty, TEntity>(Expression<Func<T, TProperty>> navigationPropertyPath)
            => WithImplementation(navigationPropertyPath, typeof(TEntity));
        public IRepositoryInMemoryBuilder<T, TKey, TState> And()
            => _builder;
    }
}