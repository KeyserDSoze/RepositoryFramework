...
namespace RepositoryFramework.Population
{
    internal class AbstractPopulationService : IRandomPopulationService
    {
        ...
        public dynamic GetValue(RandomPopulationOptions options)
        {
            try
            {
                return options.PopulationService.Construct(MockedAssembly.Instance.GetTypeByName(options.Type)!,
        ...
        private class MockedAssembly
        {
            ...
            {
#warning it doesn't work with generic methods, protected and private protected too
