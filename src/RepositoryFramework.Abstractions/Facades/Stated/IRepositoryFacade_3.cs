namespace RepositoryFramework
{
    ...
    public interface IRepositoryFacade<T, TKey, TState> : IQueryFacade<T, TKey, TState>, ICommandFacade<T, TKey, TState>, IRepositoryPattern<T, TKey, TState>, ICommandPattern<T, TKey, TState>, IQueryPattern<T, TKey, TState>, IRepositoryPattern, ICommandPattern, IQueryPattern
        where TKey : notnull
    {
