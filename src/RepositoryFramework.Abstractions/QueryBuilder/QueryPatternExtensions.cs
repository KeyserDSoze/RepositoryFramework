...
namespace System.Linq
{
    public static class QueryPatternExtensions
    {
        ...
        public static ValueTask<List<T>> ToListAsEntityAsync<T, TKey>(this IQueryPattern<T, TKey> query, CancellationToken cancellationToken = default)
         where TKey : notnull
           => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).ToListAsEntityAsync(cancellationToken);
        /// <summary>
        ...
        public static IAsyncEnumerable<T> QueryAsEntityAsync<T, TKey>(this IQueryPattern<T, TKey> query, CancellationToken cancellationToken = default)
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).QueryAsEntityAsync(cancellationToken);
        /// <summary>
        ...
        public static QueryBuilder<T, TKey> Where<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).Where(predicate);
        /// <summary>
        ...
        public static QueryBuilder<T, TKey> Take<T, TKey>(this IQueryPattern<T, TKey> query,
            int top)
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).Take(top);
        /// <summary>
        ...
        public static QueryBuilder<T, TKey> Skip<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).Skip(skip);
        /// <summary>
        ...
        public static QueryBuilder<T, TKey> OrderBy<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).OrderBy(predicate);
        /// <summary>
        ...
        public static QueryBuilder<T, TKey> OrderByDescending<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).OrderByDescending(predicate);
        /// <summary>
        ...
        public static IAsyncEnumerable<IAsyncGrouping<TProperty, IEntity<T, TKey>>> GroupByAsync<TProperty, T, TKey>(
            ...
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).GroupByAsync(predicate, cancellationToken);
        /// <summary>
        ...
        public static ValueTask<bool> AnyAsync<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            CancellationToken cancellationToken = default)
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).AnyAsync(predicate, cancellationToken);
        /// <summary>
        ...
        public static ValueTask<IEntity<T, TKey>?> FirstOrDefaultAsync<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).FirstOrDefaultAsync(predicate, cancellationToken);
        /// <summary>
        ...
        public static ValueTask<IEntity<T, TKey>> FirstAsync<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).FirstAsync(predicate, cancellationToken);
        /// <summary>
        ...
        public static Task<IPage<T, TKey>> PageAsync<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            CancellationToken cancellationToken = default)
            where TKey : notnull
           => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).PageAsync(page, pageSize, cancellationToken);
        /// <summary>
        /// List the query.
        /// </summary>
        /// <typeparam name="T">Model used for your repository.</typeparam>
        ...
        public static ValueTask<List<IEntity<T, TKey>>> ToListAsync<T, TKey>(this IQueryPattern<T, TKey> query,
            CancellationToken cancellationToken = default)
            where TKey : notnull
           => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).ToListAsync(cancellationToken);
        /// <summary>
        ...
        public static ValueTask<long> CountAsync<T, TKey>(this IQueryPattern<T, TKey> query,
            ...
            CancellationToken cancellationToken = default)
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).CountAsync<long>(predicate, cancellationToken);
        /// <summary>
        ...
        public static ValueTask<TProperty> SumAsync<T, TKey, TProperty>(
            ...
            CancellationToken cancellationToken = default)
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).SumAsync(predicate, cancellationToken);
        /// <summary>
        ...
        public static ValueTask<TProperty> AverageAsync<T, TKey, TProperty>(
            ...
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).AverageAsync(predicate, cancellationToken);
        /// <summary>
        ...
        public static ValueTask<TProperty> MaxAsync<T, TKey, TProperty>(
            ...
            Expression<Func<T, TProperty>> predicate, CancellationToken cancellationToken = default)
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).MaxAsync(predicate, cancellationToken);
        /// <summary>
        ...
        public static ValueTask<TProperty> MinAsync<T, TKey, TProperty>(
            ...
            Expression<Func<T, TProperty>> predicate, CancellationToken cancellationToken = default)
            where TKey : notnull
            => new QueryBuilder<T, TKey>(query, query as IAggregationPattern<T, TKey>).MinAsync(predicate, cancellationToken);
    }
}
