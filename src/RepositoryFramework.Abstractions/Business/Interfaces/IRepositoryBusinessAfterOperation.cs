namespace RepositoryFramework
{
    ...
    public interface IRepositoryBusinessAfterOperation<T, TKey>
        where TKey : notnull
    {
        ValueTask<TProperty> AfterOperationAsync<TProperty>(TProperty result, OperationType<TProperty> operation, Query query, CancellationToken cancellationToken = default);
    }
}
